    ...
    async.each(this.objectsToRemove, function (item, asCb) {
      ...
      if (typeof item === "object") {
        ...
        if (typeof item._id === "object") {
          ...
          console.log("in obj else");
          id = item;
        }

      } else {
        console.log("new objID");
        id = new obj(item);
      }
      ...
      console.log(_this.qry);
      _this.collection.find(_this.qry, function (err, res) {
        console.log("DELETE", err);
        res.toArray(function (err, rsult) {
          console.log("THE UMPALUMPA !");
          console.log(rsult);
        });
